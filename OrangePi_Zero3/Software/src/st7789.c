...
void ST7789_Init(void)
{
	/*wiringPi初始化*/
	wiringPiSetup();
	wiringPiSPISetupMode(ST7789_SPI_CHANNAL, ST7789_SPI_PORT, ST7789_SPI_SPEED, 0);
	
	pinMode(ST7789_RST_PIN, OUTPUT);
	digitalWrite(ST7789_RST_PIN, HIGH);
	pinMode(ST7789_DC_PIN, OUTPUT);
